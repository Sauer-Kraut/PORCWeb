    ...
    <div class="division">
        ...
        <div :class="{ body: isDivisionExpanded, nothing: !isDivisionExpanded }" v-if="load">
            <div class="conatiner display-flex justify-content-center row" v-if="!empty">
                <div
                    :class="{ 'col-8 col-md-0-custom felx-1': !isLeaderbordExpanded, 'col-12-cust': isLeaderbordExpanded }"
                    class="row display-flex justify-content-center transition-width"
                ...
                <div
                    :class="{
                        'col-xxl-4 col-xl-4 col-lg-6 display-flex justify-content-center p-3 col-md-6': !isLeaderbordExpanded,
                        'col-super-tiny-mini p-0': isLeaderbordExpanded,
                    }"
