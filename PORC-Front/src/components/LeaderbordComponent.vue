...
<template>
    <div class="leaderboard row justify-content-center d-flex">
        <div class="row collum-title justify-content-center d-flex leaderboard-row">
            ...
            <div class="col-3 add-col" title="This shows the average match score difference over all played sets.">Advantage</div>
        </div>
        <div class="p-1"></div>
        <div v-for="(player, index) in internalPerformances" :key="player.player.id" class="leaderboard-row row justify-content-center d-flex content">
            ...
            <div class="col-1 add-col"></div>
            <div class="col-3 add-col" title="This shows the average match score difference over all played sets."> {{ player.cumulative_match_difference / player.matches }}</div>
        </div>
        <div class="ß-1"></div>
        <div></div>
        <!-- <div class="col-4">
