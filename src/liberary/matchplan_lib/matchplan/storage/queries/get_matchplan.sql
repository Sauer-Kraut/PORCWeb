...
m.score_challenger AS player_1_score,

a2.username AS player_2_tag,
a2.id AS player_2_id,
m.score_opponent AS player_2_score,
...
FROM matches m 
JOIN participants p1 ON p1.id = m.challenger
JOIN participants p2 ON p2.id = m.opponent
